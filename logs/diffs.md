...
-----You are not permitted to copy, modify, translate, or adapt any part of **BCFCODEwars**, including its code, design, structure, or materials, without express written permission from the author. This prohibition includes—but is not limited to—reusing the code, architecture, or concepts within other projects.
----+You are not permitted to copy, modify, translate, or adapt any part of **BCFCODE**, including its code, design, structure, or materials, without express written permission from the author. This prohibition includes—but is not limited to—reusing the code, architecture, or concepts within other projects.
---- 
---- ## 3. No Commercial Use  
-----**BCFCODEwars** is made available for personal and educational use only. Commercial use of any kind—including selling, licensing, offering as a service, or using the project for business purposes—is strictly prohibited unless explicitly authorized through a separate agreement with the author.
----+**BCFCODE** is made available for personal and educational use only. Commercial use of any kind—including selling, licensing, offering as a service, or using the project for business purposes—is strictly prohibited unless explicitly authorized through a separate agreement with the author.
---- 
---- ## 4. Intellectual Property  
-----All intellectual property related to **BCFCODEwars**—including copyrights, patents, trademarks, and trade secrets—remains the sole property of the author. No rights or licenses are granted to you beyond what is explicitly stated here.
----+All intellectual property related to **BCFCODE**—including copyrights, patents, trademarks, and trade secrets—remains the sole property of the author. No rights or licenses are granted to you beyond what is explicitly stated here.
---- 
---- ## 5. No Redistribution  
-----You are not allowed to distribute, sublicense, lease, or lend **BCFCODEwars** or its code to any third party without written consent from the author. This includes uploading the project to third-party hosting services, repositories, or mirrors.
----+You are not allowed to distribute, sublicense, lease, or lend **BCFCODE** or its code to any third party without written consent from the author. This includes uploading the project to third-party hosting services, repositories, or mirrors.
---- 
---- ## 6. Contributions  
-----By contributing suggestions, ideas, or code to **BCFCODEwars**, you acknowledge that your contributions become the property of the original author. The author reserves the right to use, modify, or incorporate these contributions without any obligation to provide attribution or compensation.
----+By contributing suggestions, ideas, or code to **BCFCODE**, you acknowledge that your contributions become the property of the original author. The author reserves the right to use, modify, or incorporate these contributions without any obligation to provide attribution or compensation.
---- 
---- ## 7. Termination  
-----Violation of these terms will result in the immediate termination of your rights to use, view, or distribute **BCFCODEwars**. Upon termination, you are required to cease all use of the project and destroy any copies you possess.
----+Violation of these terms will result in the immediate termination of your rights to use, view, or distribute **BCFCODE**. Upon termination, you are required to cease all use of the project and destroy any copies you possess.
---- 
---- ## 8. Disclaimer of Warranty  
-----**BCFCODEwars** is provided "as-is" without any warranties, whether express or implied, including but not limited to warranties of merchantability, fitness for a particular purpose, or non-infringement. The author assumes no liability for any damages resulting from the use of this project.
----+**BCFCODE** is provided "as-is" without any warranties, whether express or implied, including but not limited to warranties of merchantability, fitness for a particular purpose, or non-infringement. The author assumes no liability for any damages resulting from the use of this project.
---- 
---- ## 9. Limitation of Liability  
-----Under no circumstances shall the author be liable for any damages, claims, or losses resulting from your use of or inability to use **BCFCODEwars**, including direct, indirect, incidental, or consequential damages.
----+Under no circumstances shall the author be liable for any damages, claims, or losses resulting from your use of or inability to use **BCFCODE**, including direct, indirect, incidental, or consequential damages.
---- 
---- ## 10. Governing Law  
...
----+        specifier: ^1.1.8
----+        version: 1.1.8(@types/react-dom@19.0.2(@types/react@19.0.1))(@types/react@19.0.1)(react-dom@19.0.0(react@19.0.0))(react@19.0.0)
----+      '@sentry/nextjs':
----+        specifier: ^9.19.0
...
----+        specifier: ^6.11.0
----+        version: 6.21.0(@typescript-eslint/parser@8.28.0(eslint@8.48.0)(typescript@5.7.2))(eslint@8.48.0)(typescript@5.7.2)
----+      husky:
----+        specifier: ^9.1.7
----+        version: 9.1.7
----+      lint-staged:
...
---- 
-----  '@mui/material-nextjs@5.18.0':
-----    resolution: {integrity: sha512-LPmUAW+xlAF1pJqYe80X238k+PqPJxjnbk/akBGDRlG3PjSafc6VbKabcr71ogTOmW4aqj7Lj6LM+YESJzYzbA==}
-----    engines: {node: '>=12.0.0'}
-----    peerDependencies:
...
---- 
-----  '@toolpad/core@0.5.2':
-----    resolution: {integrity: sha512-GsV3d3vzhTUKD5YKEMvH/HXPr1RikbgYHwZWtiFQ+O69oj/3sbRNsAPV/yvxfEL2VwHssOrhotu1PruJ5cMeDg==}
-----    engines: {node: '>=14.0.0'}
...
---- 
-----  '@toolpad/utils@0.5.2':
-----    resolution: {integrity: sha512-DC7V/l5L9YuIiJXEm3d3rhF8U0l7tyhKg05qm4TB4vHlRLCuGJs15ZetDS8W9XkxG8IHOErVrFqwlUcuIyQoJg==}
...
----+
----+  '@sentry/nextjs@9.19.0':
----+    resolution: {integrity: sha512-VE8xCIHaJBNF7DdiaG3MhBvUn5EWSJyCrrbtEkY5cvlo5pc19tBaxDwGJQfK63Z0DuZCuG9lwih7jCdmCXziwA==}
----+    engines: {node: '>=18'}
----+    peerDependencies:
----+      next: ^13.2.0 || ^14.0 || ^15.0.0-rc.0
----+
----+  '@sentry/node@9.19.0':
----+    resolution: {integrity: sha512-WKVcUBy5Zc+LGvfV/CfGPBDfnmEOSxLCMYzXIhx0gUxf2+8WpMMc/8yW/25zbXMo3eC4oST4GBDSpTfNdMBz1w==}
----+    engines: {node: '>=18'}
----+
----+  '@sentry/opentelemetry@9.19.0':
----+    resolution: {integrity: sha512-Js6153kW5mNjjukk6TVb04D/8DDhA9MO++WRzXWzNP+FiPi5zwtvm+Je2TvTeAjSH74f6o2JpfECdrfPYHWopA==}
----+    engines: {node: '>=18'}
----+    peerDependencies:
----+      '@opentelemetry/api': ^1.9.0
...
----+    resolution: {integrity: sha512-oPWFCYMYvzaEyyR/HDS42RniHoQA+p32UysAa6yW3HrTs5139d41R8+qaX1TUVKlcNVVTePajCz/V37fBBaPpA==}
----+    engines: {node: '>=18'}
----+
...
----+
----+  '@types/sort-by@1.2.3':
----+    resolution: {integrity: sha512-Q8Pg7o2iHWFf7pR4jIGb+ntxwwL7a/WWLFNJj8jEN14tPQdfwZLCqK68q6mo1WONqa68OysEPuFvNA3uGm0crw==}
----+
...
-----    resolution: {integrity: sha512-pgRc4hJ4/sNjWCSS9AmnS40x3bNMDTknHgL5UaMBTMyJnU90EgWh1Rz+MC9eFu4BuN/UwZjKQuY/1v3rM7HMfg==}
-----    engines: {node: '>= 0.4'}
----+  '@dnd-kit/modifiers@7.0.0(@dnd-kit/core@6.3.1(react-dom@19.0.0(react@19.0.0))(react@19.0.0))(react@19.0.0)':
----+    dependencies:
----+      '@dnd-kit/core': 6.3.1(react-dom@19.0.0(react@19.0.0))(react@19.0.0)
----+      '@dnd-kit/utilities': 3.2.2(react@19.0.0)
----+      react: 19.0.0
...
----+      '@types/react-dom': 19.0.2(@types/react@19.0.1)
----+
----+  '@radix-ui/react-checkbox@1.1.4(@types/react-dom@19.0.2(@types/react@19.0.1))(@types/react@19.0.1)(react-dom@19.0.0(react@19.0.0))(react@19.0.0)':
----+    dependencies:
----+      '@radix-ui/primitive': 1.1.1
----+      '@radix-ui/react-compose-refs': 1.1.1(@types/react@19.0.1)(react@19.0.0)
----+      '@radix-ui/react-context': 1.1.1(@types/react@19.0.1)(react@19.0.0)
...
-----      sparse-bitfield: 3.0.3
-----
-----  '@mui/base@5.0.0-beta.40(@types/react@18.3.23)(react-dom@18.3.1(react@18.3.1))(react@18.3.1)':
-----    dependencies:
-----      '@babel/runtime': 7.28.2
-----      '@floating-ui/react-dom': 2.1.5(react-dom@18.3.1(react@18.3.1))(react@18.3.1)
...
-----      '@types/react': 18.3.23
-----
-----  '@mui/material-nextjs@5.18.0(@emotion/cache@11.14.0)(@mui/material@5.18.0(@emotion/react@11.14.0(@types/react@18.3.23)(react@18.3.1))(@emotion/styled@11.14.1(@emotion/react@11.14.0(@types/react@18.3.23)(react@18.3.1))(@types/react@18.3.23)(react@18.3.1))(@types/react@18.3.23)(react-dom@18.3.1(react@18.3.1))(react@18.3.1))(@types/react@18.3.23)(next@14.2.31(react-dom@18.3.1(react@18.3.1))(react@18.3.1))(react@18.3.1)':
-----    dependencies:
-----      '@babel/runtime': 7.28.2
-----      '@mui/material': 5.18.0(@emotion/react@11.14.0(@types/react@18.3.23)(react@18.3.1))(@emotion/styled@11.14.1(@emotion/react@11.14.0(@types/react@18.3.23)(react@18.3.1))(@types/react@18.3.23)(react@18.3.1))(@types/react@18.3.23)(react-dom@18.3.1(react@18.3.1))(react@18.3.1)
...
----+      '@sentry/core': 9.19.0
---- 
-----  '@mui/utils@6.0.0-rc.0(@types/react@18.3.23)(react@18.3.1)':
-----    dependencies:
-----      '@babel/runtime': 7.28.2
-----      '@mui/types': 7.4.5(@types/react@18.3.23)
-----      '@types/prop-types': 15.7.15
...
----+  '@sentry/core@9.19.0': {}
----+
----+  '@sentry/nextjs@9.19.0(@opentelemetry/context-async-hooks@1.30.1(@opentelemetry/api@1.9.0))(@opentelemetry/core@1.30.1(@opentelemetry/api@1.9.0))(@opentelemetry/instrumentation@0.57.2(@opentelemetry/api@1.9.0))(@opentelemetry/sdk-trace-base@1.30.1(@opentelemetry/api@1.9.0))(next@15.3.2(@babel/core@7.27.1)(@opentelemetry/api@1.9.0)(react-dom@19.0.0(react@19.0.0))(react@19.0.0))(react@19.0.0)(webpack@5.99.8)':
----+    dependencies:
----+      '@opentelemetry/api': 1.9.0
----+      '@opentelemetry/semantic-conventions': 1.33.0
----+      '@rollup/plugin-commonjs': 28.0.1(rollup@4.35.0)
...
-----      '@mui/material': 5.18.0(@emotion/react@11.14.0(@types/react@18.3.23)(react@18.3.1))(@emotion/styled@11.14.1(@emotion/react@11.14.0(@types/react@18.3.23)(react@18.3.1))(@types/react@18.3.23)(react@18.3.1))(@types/react@18.3.23)(react-dom@18.3.1(react@18.3.1))(react@18.3.1)
-----      '@mui/utils': 6.0.0-rc.0(@types/react@18.3.23)(react@18.3.1)
-----      '@toolpad/utils': 0.5.2(@types/node@20.19.10)(jsdom@25.0.1)(react@18.3.1)
-----      client-only: 0.0.1
-----      invariant: 2.2.4
-----      prop-types: 15.8.1
-----      react: 18.3.1
...
-----      react-is: 18.3.1
-----      title: 3.5.3
-----      vitest: 2.0.5(@types/node@20.19.10)(jsdom@25.0.1)
-----      yaml: 2.5.0
-----      yaml-diff-patch: 2.0.0
-----    transitivePeerDependencies:
-----      - '@edge-runtime/vm'
...
----+  '@types/uuid@10.0.0': {}
----+
----+  '@typescript-eslint/eslint-plugin@6.21.0(@typescript-eslint/parser@8.28.0(eslint@8.48.0)(typescript@5.7.2))(eslint@8.48.0)(typescript@5.7.2)':
----     dependencies:
----       '@eslint-community/regexpp': 4.12.1
...
----+  '@webassemblyjs/helper-wasm-bytecode@1.13.2': {}
---- 
-----  '@vitest/mocker@2.1.9(vite@5.4.19(@types/node@20.19.10))':
----+  '@webassemblyjs/helper-wasm-section@1.14.1':
----     dependencies:
-----      '@vitest/spy': 2.1.9
-----      estree-walker: 3.0.3
-----      magic-string: 0.30.17
-----    optionalDependencies:
-----      vite: 5.4.19(@types/node@20.19.10)
----+      '@webassemblyjs/ast': 1.14.1
----+      '@webassemblyjs/helper-buffer': 1.14.1
----+      '@webassemblyjs/helper-wasm-bytecode': 1.13.2
----+      '@webassemblyjs/wasm-gen': 1.14.1
...
----+  eslint-config-next@15.1.0(eslint@8.48.0)(typescript@5.7.2):
----     dependencies:
-----      '@next/eslint-plugin-next': 14.2.31
-----      '@rushstack/eslint-patch': 1.12.0
-----      '@typescript-eslint/eslint-plugin': 8.39.1(@typescript-eslint/parser@8.39.1(eslint@8.57.1)(typescript@5.9.2))(eslint@8.57.1)(typescript@5.9.2)
...
----+      object.values: 1.2.1
----+
----+  kbar@0.1.0-beta.45(@types/react-dom@19.0.2(@types/react@19.0.1))(@types/react@19.0.1)(react-dom@19.0.0(react@19.0.0))(react@19.0.0):
----+    dependencies:
----+      '@radix-ui/react-portal': 1.1.4(@types/react-dom@19.0.2(@types/react@19.0.1))(@types/react@19.0.1)(react-dom@19.0.0(react@19.0.0))(react@19.0.0)
----+      fast-equals: 2.0.4
----+      fuse.js: 6.6.2
...
---- 
-----  mquery@5.0.0:
----+  motion@11.18.2(react-dom@19.0.0(react@19.0.0))(react@19.0.0):
----     dependencies:
-----      debug: 4.4.1
-----    transitivePeerDependencies:
-----      - supports-color
...
----   natural-compare@1.4.0: {}
---- 
-----  next-auth@5.0.0-beta.20(next@14.2.31(react-dom@18.3.1(react@18.3.1))(react@18.3.1))(react@18.3.1):
----+  neo-async@2.6.2: {}
----+
...
---- 
-----  npm-run-path@2.0.2:
----+  nextjs-toploader@3.8.16(next@15.3.2(@babel/core@7.27.1)(@opentelemetry/api@1.9.0)(react-dom@19.0.0(react@19.0.0))(react@19.0.0))(react-dom@19.0.0(react@19.0.0))(react@19.0.0):
----     dependencies:
-----      path-key: 2.0.1
----+      next: 15.3.2(@babel/core@7.27.1)(@opentelemetry/api@1.9.0)(react-dom@19.0.0(react@19.0.0))(react@19.0.0)
----+      nprogress: 0.2.0
...
---- 
-----  oauth4webapi@2.17.0: {}
----+  nuqs@2.4.1(next@15.3.2(@babel/core@7.27.1)(@opentelemetry/api@1.9.0)(react-dom@19.0.0(react@19.0.0))(react@19.0.0))(react@19.0.0):
----+    dependencies:
----+      mitt: 3.0.1
----+      react: 19.0.0
----+    optionalDependencies:
...
----+      react-dom: 19.0.0(react@19.0.0)
----+
----+  react-responsive@10.0.1(react@19.0.0):
----+    dependencies:
----+      hyphenate-style-name: 1.1.0
----+      matchmediaquery: 0.4.2
----+      prop-types: 15.8.1
...
----       punycode: 2.3.1
---- 
-----  vite-node@2.0.5(@types/node@20.19.10):
----+  use-callback-ref@1.3.3(@types/react@19.0.1)(react@19.0.0):
----     dependencies:
-----      cac: 6.7.14
-----      debug: 4.4.1
...
----+      '@types/react': 19.0.1
---- 
-----  vite-node@2.1.9(@types/node@20.19.10):
----+  use-sidecar@1.1.3(@types/react@19.0.1)(react@19.0.0):
----     dependencies:
-----      cac: 6.7.14
-----      debug: 4.4.1
...
-----      - terser
-----
-----  vitest@2.1.9(@types/node@20.19.10)(jsdom@25.0.1):
-----    dependencies:
-----      '@vitest/expect': 2.1.9
-----      '@vitest/mocker': 2.1.9(vite@5.4.19(@types/node@20.19.10))
-----      '@vitest/pretty-format': 2.1.9
...
---- 
-----  yocto-queue@0.1.0: {}
----+  zustand@5.0.3(@types/react@19.0.1)(react@19.0.0)(use-sync-external-store@1.5.0(react@19.0.0)):
----+    optionalDependencies:
----+      '@types/react': 19.0.1
----+      react: 19.0.0
----+      use-sync-external-store: 1.5.0(react@19.0.0)
...
---+      '@vercel/analytics':
---+        specifier: ^1.5.0
---+        version: 1.5.0(next@15.3.2(@babel/core@7.27.1)(@opentelemetry/api@1.9.0)(react-dom@19.0.0(react@19.0.0))(react@19.0.0))(react@19.0.0)
---+      '@vercel/speed-insights':
---+        specifier: ^1.2.0
---+        version: 1.2.0(next@15.3.2(@babel/core@7.27.1)(@opentelemetry/api@1.9.0)(react-dom@19.0.0(react@19.0.0))(react@19.0.0))(react@19.0.0)
---       class-variance-authority:
---         specifier: ^0.7.1
---         version: 0.7.1
---@@ -2171,6 +2177,55 @@ packages:
---     cpu: [x64]
---     os: [win32]
--- 
---+  '@vercel/analytics@1.5.0':
...
---     resolution: {integrity: sha512-nuBEDgQfm1ccRp/8bCQrx1frohyufl4JlbMMZ4P1wpeOfDhF6FQkxZJ1b/e+PLwr6X1Nhw6OLme5usuBWYBvuQ==}
--- 
---@@ -6525,6 +6580,16 @@ snapshots:
---   '@unrs/resolver-binding-win32-x64-msvc@1.3.2':
---     optional: true
--- 
---+  '@vercel/analytics@1.5.0(next@15.3.2(@babel/core@7.27.1)(@opentelemetry/api@1.9.0)(react-dom@19.0.0(react@19.0.0))(react@19.0.0))(react@19.0.0)':
---+    optionalDependencies:
---+      next: 15.3.2(@babel/core@7.27.1)(@opentelemetry/api@1.9.0)(react-dom@19.0.0(react@19.0.0))(react@19.0.0)
---+      react: 19.0.0
---+
---+  '@vercel/speed-insights@1.2.0(next@15.3.2(@babel/core@7.27.1)(@opentelemetry/api@1.9.0)(react-dom@19.0.0(react@19.0.0))(react@19.0.0))(react@19.0.0)':
---+    optionalDependencies:
---+      next: 15.3.2(@babel/core@7.27.1)(@opentelemetry/api@1.9.0)(react-dom@19.0.0(react@19.0.0))(react@19.0.0)
---+      react: 19.0.0
---+
...
---@@ -11,9 +36,9 @@ export default async function Page() {
--- 
---   try {
...
---     );
--- 
---@@ -23,6 +48,8 @@ export default async function Page() {
---     }
---   } catch (error) {
...
---index 6865e99..9b1f770 100644
------ a/src/app/dashboard/layout.tsx
---+++ b/src/app/dashboard/layout.tsx
---@@ -6,8 +6,44 @@ import type { Metadata } from 'next';
...
---   pie_stats,
---   bar_stats,
---@@ -22,12 +72,14 @@ export default function OverViewLayout({
...
---+  --card: #ffffff;
---   --card: oklch(1 0 0);
---+  --card-foreground: #152234;
---   --card-foreground: oklch(0.145 0 0);
---+
---+  --popover: #ffffff;
---   --popover: oklch(1 0 0);
---+  --popover-foreground: #030812;
---   --popover-foreground: oklch(0.145 0 0);
----  --primary: oklch(0.205 0 0);
---+
---+  --primary: #16a087;
---+  --primary: oklch(0.64 0.17 174);
---+  --primary-foreground: #ffffff;
---   --primary-foreground: oklch(0.985 0 0);
----  --secondary: oklch(0.97 0 0);
---+
---+  --secondary: #93a8c3;
---+  --secondary: oklch(0.75 0.05 240);
---+  --secondary-foreground: #030812;
---   --secondary-foreground: oklch(0.205 0 0);
---+
---+  --muted: #e5eaf0;
---   --muted: oklch(0.97 0 0);
---+  --muted-foreground: #1e2d47;
---   --muted-foreground: oklch(0.556 0 0);
----  --accent: oklch(0.97 0 0);
----  --accent-foreground: oklch(0.205 0 0);
---+
---+  --accent: #16a087;
---+  --accent-foreground: #030812;
---+
---+  --destructive: #e24d4d;
...
---+  /* Sidebar */
---+  --sidebar: #ffffff;
---+  --sidebar-foreground: #030812;
---+  --sidebar-primary: #16a087;
---+  --sidebar-primary-foreground: #ffffff;
---+  --sidebar-accent: #93a8c3;
---+  --sidebar-accent-foreground: #030812;
---+  --sidebar-border: #d7e5f0;
---+  --sidebar-ring: #16a087;
--- }
--- 
---+/* ===== Dark Theme ===== */
...
---+
---+  --card: #081b1f;
---+  --card-foreground: #93a8c3;
---+
---+  --popover: #040915;
---+  --popover-foreground: #93a8c3;
---+
---+  --primary: #16a087;
---+  --primary-foreground: #030812;
---+
---+  --secondary: #1e2d47;
---+  --secondary-foreground: #93a8c3;
---+
---+  --muted: #152234;
---+  --muted-foreground: #93a8c3;
---+
---+  --accent: #93a8c3;
---+  --accent-foreground: #030812;
---+
...
---+
---+  --sidebar: #040915;
---+  --sidebar-foreground: #93a8c3;
---+  --sidebar-primary: #16a087;
---+  --sidebar-primary-foreground: #030812;
---+  --sidebar-accent: #1e2d47;
---+  --sidebar-accent-foreground: #93a8c3;
---+  --sidebar-border: #050c16;
---+  --sidebar-ring: #16a087;
--- }
--- 
...
----  animation: reveal 0.4s ease-in-out forwards;
---+/* ===== SEO + Accessibility ===== */
---+/* Respect system preference for crawlers & first render */
...
---   light: '#ffffff',
---@@ -16,8 +19,48 @@ const META_THEME_COLORS = {
--- };
--- 
--- export const metadata: Metadata = {
----  title: 'Next Shadcn',
...
---@@ -68,6 +111,8 @@ export default async function RootLayout({
...
---@@ -7,6 +44,6 @@ export default async function Page() {
---   if (!userId) {
...
--- }
---+
---+/* New Montserrat theme */
---+.theme-montserrat {
---+  --font-sans: var(
---+    --font-montserrat
---+  ); /* Apply Montserrat as the default sans-serif font */
---+  --primary: var(--color-neutral-600); /* Reuse neutral color for consistency */
...
---+          />
---+          <span className='ml-1 text-3xl leading-none font-semibold drop-shadow-[0_0_3px_rgba(215,229,240,0.8)]'>
---+            BCFCODE
---+          </span>
...
---         <SidebarGroup>
---diff --git a/src/components/layout/cta-github.tsx b/src/components/layout/cta-github.tsx
---index 9e03077..9e5ffa9 100644
------ a/src/components/layout/cta-github.tsx
---+++ b/src/components/layout/cta-github.tsx
...
--- interface Tenant {
---   id: string;
---@@ -52,11 +53,15 @@ export function OrgSwitcher({
---               size='lg'
...
--- 
---@@ -95,6 +102,15 @@ export function ThemeSelector() {
---               </SelectItem>
---             ))}
---           </SelectGroup>
---+          <SelectSeparator />
...
---       </Select>
---     </div>
---diff --git a/src/constants/mock-api.ts b/src/constants/mock-api.ts
---index d5c3a8b..1544926 100644
------ a/src/constants/mock-api.ts
---+++ b/src/constants/mock-api.ts
---@@ -10,7 +10,7 @@ export const delay = (ms: number) =>
--- 
...
---   description: string;
---   created_at: string;
---diff --git a/src/features/auth/components/sign-in-view.tsx b/src/features/auth/components/sign-in-view.tsx
---index 98927f5..bdab800 100644
------ a/src/features/auth/components/sign-in-view.tsx
---+++ b/src/features/auth/components/sign-in-view.tsx
---@@ -4,16 +4,42 @@ import { SignIn as ClerkSignInForm } from '@clerk/nextjs';
...
---         className={cn(
---@@ -23,45 +49,60 @@ export default function SignInViewPage({ stars }: { stars: number }) {
---       >
---         Login
---       </Link>
...
---               <IconStar
---@@ -71,14 +112,17 @@ export default function SignInViewPage({ stars }: { stars: number }) {
...
---@@ -45,5 +76,6 @@ export const fontVariables = cn(
...
-diff --git a/src/hooks/use-breadcrumbs.tsx b/src/hooks/use-breadcrumbs.tsx
-index 5e97cd5..9dbbf57 100644
---- a/src/hooks/use-breadcrumbs.tsx
-+++ b/src/hooks/use-breadcrumbs.tsx
-@@ -13,11 +13,13 @@ const routeMapping: Record<string, BreadcrumbItem[]> = {
...
+  --foreground: oklch(0.16 0 270);
 
-  --card: #ffffff;
   --card: oklch(1 0 0);
-  --card-foreground: #152234;
-  --card-foreground: oklch(0.145 0 0);
+  --card-foreground: oklch(0.16 0 270);
 
-  --popover: #ffffff;
   --popover: oklch(1 0 0);
-  --popover-foreground: #030812;
-  --popover-foreground: oklch(0.145 0 0);
+  --popover-foreground: oklch(0.16 0 270);
 
-  --primary: #16a087;
-  --primary: oklch(0.64 0.17 174);
-  --primary-foreground: #ffffff;
-  --primary-foreground: oklch(0.985 0 0);
+  --primary: oklch(0.64 0.17 174); /* Teal-green */
...
-  --secondary-foreground: #030812;
-  --secondary-foreground: oklch(0.205 0 0);
+  --secondary: oklch(0.75 0.05 250); /* Soft blue-gray */
+  --secondary-foreground: oklch(0.20 0 270);
...
+  --muted-foreground: oklch(0.55 0 270);
 
-  --accent: #16a087;
-  --accent-foreground: #030812;
+  --accent: oklch(0.70 0.12 200); /* Modern cyan accent */
+  --accent-foreground: oklch(0.16 0 270);
...
+  --chart-3: oklch(0.42 0.04 250);
+  --chart-4: oklch(0.28 0.04 250);
+  --chart-5: oklch(0.14 0.02 250);
...
+  --card-foreground: oklch(0.85 0.03 240);
 
-  --destructive: #e24d4d;
-  --destructive-foreground: #ffffff;
+  --popover: oklch(0.16 0.03 260);
+  --popover-foreground: oklch(0.85 0.03 240);
...
-  --sidebar-ring: #16a087;
+  --primary: oklch(0.64 0.17 174);
+  --primary-foreground: oklch(0.16 0 270);
+
+  --secondary: oklch(0.35 0.03 260);
+  --secondary-foreground: oklch(0.80 0.03 240);
+
...
+  --chart-1: var(--primary);
+  --chart-2: var(--secondary);
+  --chart-3: oklch(0.50 0.04 250);
+  --chart-4: oklch(0.30 0.04 250);
+  --chart-5: oklch(0.20 0.02 250);
+
