...
import { DiamondsCountBadge } from './DiamondsCountBadge';
 ...
 */
export function DiamondsCollectButton({ count }: { count: number }) {
  ...
  return (
    <button
      ...
      className={clsx(
        ...
        'p-6 text-center shadow-xl transition-transform duration-200 hover:scale-[1.02] active:scale-[0.98]',
    ...
    >
      ...
      <div className='relative z-10'>
        <DiamondsCountBadge size='md' count={count}>
          {/* keep passing isLoading if your DiamondIcon supports it; harmless if ignored */}
          <DiamondIcon isLoading={loading} size='lg' />
        </DiamondsCountBadge>
      </div>
      ...
      <span
        className={clsx(
          'mt-4 font-bold text-amber-700 dark:text-amber-300',
