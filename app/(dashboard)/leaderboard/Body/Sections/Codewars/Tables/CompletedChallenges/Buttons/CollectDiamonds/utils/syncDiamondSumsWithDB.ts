...
// export default async function syncDiamondSumsWithDB(currentUser: CurrentUser) {
//   // console.log("Running syncDiamondSumsWithDB... (in syncDiamondSumsWithDB)", currentUser);
//   // try {
//   //   // console.log("syncDiamondSumsWithDB  > currentUser", currentUser);
//   //   await updateCurrentUser(currentUser);
//   // } catch (error) {
//   //   console.error("syncDiamondSumsWithDB failed:", error);
//   // }
